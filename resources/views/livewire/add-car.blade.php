<div class="" x-data="{ modalCar: @entangle('modalCar') }">
    ...
    <div x-show="modalCar" class="absolute inset-0 z-40 bg-black opacity-80"></div>
    <div class="absolute top-0 left-0 right-0 z-50 h-screen overflow-y-scroll shadow-lg" id="addBuku" x-show="modalCar">
        ...
        <div class="flex items-center justify-center p-12" x-data="{ open: false }">
            ...
            <div wire:ignore.self class="mx-auto w-full max-w-[550px] bg-white">
                ...
                wire:submit.prevent="store" @endif
                    ...
                    @csrf
                    <div class="flex justify-between w-full mb-5 space-x-10">
                        <div>
                    ...
                    <div class="mb-5">
                        ...
                        <select name="status" id="" wire:model.change="status" wire:change="reloadCars"
                            class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                    ...
                    <div class="pt-4 mb-6">
                        ...
                        <div class="mb-8">
                            <input type="file" wire:change="reloadCars" name="foto" wire:model="foto"
                                id="foto" class="sr-only" />
                            <label for="foto"
